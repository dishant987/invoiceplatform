...
import ViewInvoiceSkeleton from "@/app/components/ViewInvoiceSkeleton";
          ...
          <form className="space-y-6 sm:space-y-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              <div className="flex flex-col gap-2">
                <Label>Draft</Label>
                <Badge className="w-[90px]">{data?.draft}</Badge>
              </div>
              <div className="flex flex-col gap-2">
                <Label>Status</Label>
                <Badge
            ...
            <div className="flex justify-end">
              <div className="w-full sm:w-1/2">
                <div className="flex justify-between gap-4 sm:gap-32 mb-3">
                  <span>Subtotal</span>
                ...
                <div className="flex justify-between gap-4 sm:gap-32 border-t pt-3">
